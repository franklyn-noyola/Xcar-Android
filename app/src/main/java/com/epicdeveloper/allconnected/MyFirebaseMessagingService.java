...
import static com.epicdeveloper.allconnected.MainActivity.getBackGround;
import static com.epicdeveloper.allconnected.MainActivity.plateUser;
                        ...
                        if (snapshot.exists()) {
                            ...
                            if (!TextUtils.isEmpty(plateUser)) {
                                if (titulo.contains("Chat")) {
                                    String chat = com.epicdeveloper.allconnected.ui.Chat.fragment_chat.class.getCanonicalName();
                                    idNotify=0;
                                ...
                                if (titulo.contains("Notificación")) {
                                    String chat = com.epicdeveloper.allconnected.ui.receivedNotifications.viewNotification.class.getCanonicalName();
                                ...
                                String chat = com.epicdeveloper.allconnected.MainActivity.class.getCanonicalName();
                                try {
                                    notiUser = titulo.substring(14);
                                    classToClick = Class.forName(chat);
                                } catch (ClassNotFoundException e) {
